<?php echo $resource->UnitResourceUploadDate; ?>
<h6 style="margin-left: 10px;margin-bottom: 0px;">
    <button onclick="document.location;" type="button" class="btn btn-round">    
    ...
    #<?php echo $resourceIndex; ?> - <?php echo $resource->UnitResourceName; ?>
</h6>
